#!/usr/bin/env python
#
# Source: https://github.com/notofonts/nototools/blob/main/nototools/merge_fonts.py
#
...
files = [
    ...
    "NotoSansMono_SemiCondensed-Medium.ttf",
    "NotoEmoji-Bold-Scaled.ttf",
]
...
def main():
    ...
    merger = merge.Merger(options=merge.Options(drop_tables=["vhea", 'vmtx']))
